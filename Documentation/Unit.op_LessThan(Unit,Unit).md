...
<a name='Emik.Results.Unit.op_LessThan(Emik.Results.Unit,Emik.Results.Unit).left'></a>

`left` [Unit](Unit.md 'Emik.Results.Unit')

The left-hand side parameter.

<a name='Emik.Results.Unit.op_LessThan(Emik.Results.Unit,Emik.Results.Unit).right'></a>
